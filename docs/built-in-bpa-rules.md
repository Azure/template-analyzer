...
**Recommendation**: Set the *properties.enabled* property to false, to ensure direct access to the management REST API is disabled
#### Severity: 3
...
### TA-000035: API Management Named Value secrets should be stored in Azure Key Vault
...
**Recommendation**: To utilize secrets stored in Key Vault for Azure API Management, learn more [here](https://learn.microsoft.com/en-us/azure/api-management/api-management-howto-properties?tabs=azure-portal#key-vault-secrets).
#### Severity: 2
...
**Recommendation**: To learn more about Virtual Networks for Azure API Management, please visit [here](https://aka.ms/apim-vnet).To see an example on how to configure a VNet via Azure Policy, please visit [here](https://learn.microsoft.com/en-us/samples/azure/azure-quickstart-templates/api-management-create-with-internal-vnet-application-gateway/).
#### Severity: 2
