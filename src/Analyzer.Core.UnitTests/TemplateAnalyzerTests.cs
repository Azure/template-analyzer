...
namespace Microsoft.Azure.Templates.Analyzer.Core.UnitTests
{
    ...
    public class TemplateAnalyzerTests
    {
        ...
        [DataRow(@"{ ""azureActiveDirectory"": { ""someProperty"": ""propertyValue"" } }", "Microsoft.ServiceFabric/clusters", 2, 0, DisplayName = "1 matching resource with 2 failing evaluation")]
        ...
        [DataRow(@"{ ""azureActiveDirectory"": { ""tenantId"": ""tenantId"" } }", "Microsoft.ServiceFabric/clusters", 3, 1, @"{ ""azureActiveDirectory"": { ""someProperty"": ""propertyValue"" } }", DisplayName = "3 matching resources with 1 passing evaluation")]
