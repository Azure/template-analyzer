...
namespace Microsoft.Azure.Templates.Analyzer.RuleEngines.JsonEngine
{
    ...
    {
        /// <summary>
        /// Delegate for building an <see cref="ISourceLocationResolver"/>
        /// </summary>
        /// <param name="context">The <see cref="TemplateContext"/> being evaluated.</param>
        /// <returns>An <see cref="ISourceLocationResolver"/> to resolve line numbers for the given template context.</returns>
        public delegate ISourceLocationResolver BuildILineNumberResolver(TemplateContext context);
        ...
        /// <param name="jsonLineNumberResolverBuilder">A builder to create an <see cref="ISourceLocationResolver"/> for mapping JSON paths from a
