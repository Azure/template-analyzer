...
namespace Microsoft.Azure.Templates.Analyzer.RuleEngines.JsonEngine.UnitTests
{
    ...
    public class LeafExpressionTests
    {
        ...
        public void Evaluate_ValidScope_ReturnsResultsOfOperatorEvaluation(string resourceType, string path, int lineNumber, bool expectedEvaluationResult)
        {
            ...
            mockJsonPathResolver
                .Setup(s => s.ResolveResourceType(It.Is<string>(r => string.Equals(r, resourceType)), null, null))
            ...
            mockJsonPathResolver.Verify(s => s.ResolveResourceType(It.Is<string>(r => string.Equals(r, resourceType)), null, null), Times.Exactly(resourceType == null ? 0 : 1));
            ...
            mockResourcesResolved.Verify(s => s.ResolveResourceType(It.IsAny<string>(), null, null), Times.Never);
