...
namespace Microsoft.Azure.Templates.Analyzer.RuleEngines.JsonEngine.UnitTests
{
    ...
    public class ExpressionTests
    {
        ...
        public void EvaluateInternal_HasWhereCondition_LineNumberResolverNotPassed()
        {
            ...
            whereExpression
                .Setup(w => w.Evaluate(It.IsAny<IJsonPathResolver>(), It.IsAny<ILocationResolver>()))
                .Returns((IJsonPathResolver pathResolver, ILocationResolver lineNumberResolver) =>
                {
            ...
            mockExpression.Evaluate(mockPathResolver.Object, new Mock<ILocationResolver>().Object);
        ...
        public void EvaluateInternalGetEvaluation_NullScope_ThrowsException()
        {
            ...
            new MockExpression(new ExpressionCommonProperties { Path = "path" })
                .Evaluate(null, new Mock<ILocationResolver>().Object);
        }
